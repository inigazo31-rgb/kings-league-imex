...
export function openRoleSwitcherModal() {
      ...
      <div style="display: flex; flex-direction: column; gap: 1.25rem;">
        ...
        <div class="form-group" style="margin-top: 0.5rem;">
          ...
          <div style="display: flex; gap: 0.5rem;">
            <select id="selectPresiTeam" class="form-select">
              ${teamsOptions}
            </select>
            <button class="btn btn-lime" id="btnConfirmPresiRole" style="white-space: nowrap;">
              Entrar
            </button>
          </div>
        </div>
  ...
  document.getElementById("switchRoleAdmin")?.addEventListener("click", () => {
  ...
  document.getElementById("btnConfirmPresiRole")?.addEventListener("click", () => {
    const teamId = document.getElementById("selectPresiTeam").value;
    store.switchRole("PRESIDENT", teamId);
